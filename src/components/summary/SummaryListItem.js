const SummaryListItem = ({ attribute }) => {
    ...
    const backgroundUrl = `${process.env.REACT_APP_FRONTEND_URL}${attribute.thumbnailUrl}.webp`
                ...
                <div style={{ "border": "solid 2px green" }}>
                    <div className="d-flex mx-3 my-3">
                        ...
                        {attribute.thumbnailUrl ?
                            <div className="w-25"><button className="color-button" style={{ "background": `url(${backgroundUrl})`, "backgroundSize" : "52px 52px"}} disabled></button></div>
